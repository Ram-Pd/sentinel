      ...
      <div className="w-full max-w-sm z-10">
        ...
        >
          ...
          <div className="mt-6">
            ...
            <button
              type="button"
              className="mt-6 w-full flex items-center justify-center space-x-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-700 dark:text-white font-semibold py-3.5 rounded-xl transition-all shadow-sm"
            >
